...
PHPSysInfo jest skryptem PHP, który możemy dopasować do naszych
potrzeb. Przetwarza on /proc, i w ładny sposób pokazuje informacje
m.in. na temat: uptime, procesora, pamięci, urządzeń PCI, SCSI, IDE,
